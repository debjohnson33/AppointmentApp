        ...
        return(
          <nav className="navigation navbar navbar-default">
            <div className="container-fluid">
              <div className="navbar-header"><a className="navbar-brand" href="#">Johnson Pet Medicine</a></div>
                    ...
                    <div className="input-group-btn">
                      <button type="button" className="btn btn-info dropdown-toggle"
                        ...
                        <ul className="dropdown-menu dropdown-menu-right">
                          ...
                          {(this.props.orderBy) === 'petName' ? <span className="glyphicon glyphicon-ok"></span> : null}
                          </a></li>
                          <li><a href="#" id="aptDate" onClick={this.handleSort}>Date
                          {(this.props.orderBy) === 'aptDate' ? <span className="glyphicon glyphicon-ok"></span> : null}
                          </a></li>
                          <li><a href="#" id="ownerName" onClick={this.handleSort}>Owner
                          {(this.props.orderBy) === 'ownerName' ? <span className="glyphicon glyphicon-ok"></span> : null}
                          </a></li>
                          <li role="separator" className="divider"></li>
                          <li><a href="#" id="asc" onClick={this.handleOrder}>Asc
                          {(this.props.orderDir) === 'asc' ? <span className="glyphicon glyphicon-ok"></span> : null}
                          </a></li>
                          <li><a href="#" id="desc" onClick={this.handleOrder}>Desc
                          {(this.props.orderDir) === 'desc' ? <span className="glyphicon glyphicon-ok"></span> : null}
                          </a></li>
                        </ul>
                    </div>{/* input-group-btn */}
                </div>{/* input-group */}
